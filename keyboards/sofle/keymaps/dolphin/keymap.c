...
[CPLAYER] = LAYOUT( \
  _______,   _______,   _______,    LCA(KC_ENT),    _______,    _______,                 _______,    _______,    _______,    _______,    _______,  _______, \
  _______,   LALT(LGUI(KC_BSPC)),   LCA(KC_D),    LCA(KC_UP),    LCA(KC_E),    _______,          _______,    _______,    _______,    _______,    _______,  _______, \
  _______,   LALT(LGUI(KC_SPC)),   LCA(KC_LEFT),    LCA(KC_DOWN),    LCA(KC_RIGHT),             _______,    _______,    _______,    _______,    _______, _______,  _______, \
  _______, LCMD(KC_Z), LCMD(KC_X),  LCMD(KC_C),    LCMD(KC_V),   LALT(LGUI(KC_V)),            _______,    _______, _______,  _______,    _______,  _______, _______,  _______, \
  _______, _______, _______, _______, _______,      _______,  _______, _______, _______, _______ \
),
[ARROWLAYER] = LAYOUT( \
  _______,   _______,   _______,    _______,    _______,    _______,         _______,    _______,    _______,    _______,    _______,  _______, \
  _______,   _______,   _______,    KC_EQUAL,    _______,    _______,         _______,    _______,    KC_UP,    _______,    _______,  _______, \
  _______,   _______,   _______,    KC_MINUS,    KC_RIGHT_ANGLE_BRACKET,    _______,         _______,    KC_LEFT,    KC_DOWN,    KC_RIGHT, _______,  _______, \
...
[BRALAYER] = LAYOUT( \
  ...
  _______, _______, _______,  _______,    _______,               _______, _______,     _______, _______,  _______,    _______,  _______, _______,  _______, \
    _______, _______, _______, _______, _______,      _______,  KC_LEFT, _______, _______, _______ \
)
};
